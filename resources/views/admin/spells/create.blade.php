...
@section('title', 'Create New Spell')
...
<div class="d-flex align-items-center mb-3">
    ...
    <h1 class="admin-page-title mb-0">Create New Spell</h1>
</div>

<div class="admin-card">
    <form action="{{ route('admin.spells.store') }}" method="POST" enctype="multipart/form-data" class="admin-form">
        @csrf
                ...
                <div class="mb-3">
                    ...
                    <div class="file-upload-box" id="pdfUploadBox">
                        ...
                        <div class="file-upload-text">
                            Click to upload your PDF spell document<br>
                            <span class="text-muted">(Maximum 10MB)</span>
                        </div>
                        <div class="file-name-preview" id="pdfFileName"></div>
                    </div>
                    <input type="file" name="pdf_file" id="pdf_file" class="d-none" accept=".pdf" required>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="price" id="price" class="form-control" value="{{ old('price', 5.55) }}" step="0.01" min="0" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="currency" id="currency" class="form-control" value="{{ old('currency', 'AUD') }}" maxlength="3" required>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="chapter-item">
                                        <div class="form-check">
                                            <input type="checkbox" name="related_chapters[]" id="chapter-{{ $chapter->id }}" 
                                                ...
                                                {{ in_array($chapter->id, old('related_chapters', [])) ? 'checked' : '' }}>
        ...
        <div class="d-flex justify-content-between mt-4">
            ...
            <button type="submit" class="btn btn-admin-primary">
                <i class="fas fa-save"></i> Create Spell
            </button>
        </div>
    </form>
</div>
