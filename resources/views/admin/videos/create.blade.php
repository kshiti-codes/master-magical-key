...
@section('content')
<h1 class="admin-page-title">Add New Training Video</h1>

<div class="admin-card">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="admin-card-title mb-0">Video Details</h2>
        <a href="{{ route('admin.videos.index') }}" class="btn-admin-secondary">
    ...
    <form action="{{ route('admin.videos.store') }}" method="POST" class="admin-form">
        @csrf
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="order_sequence" id="order_sequence" class="form-control @error('order_sequence') is-invalid @enderror" value="{{ old('order_sequence', 0) }}" min="0" required>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="url" name="video_path" id="video_path" class="form-control @error('video_path') is-invalid @enderror" value="{{ old('video_path') }}" required>
                @error('video_path')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="url" name="thumbnail_path" id="thumbnail_path" class="form-control @error('thumbnail_path') is-invalid @enderror" value="{{ old('thumbnail_path') }}">
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="number" name="duration" id="duration" class="form-control @error('duration') is-invalid @enderror" value="{{ old('duration') }}" min="0">
                @error('duration')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
        ...
        <div class="mb-4">
            <div class="form-check">
                ...
                <label class="form-check-label d-block" for="is_published" style="margin-left: 1.5rem;">Publish Immediately</label>
        ...
        <div class="admin-form-actions">
            <button type="submit" class="btn-admin-primary">Create Video</button>
